    ...
    <div class="revolution_slider">
      ...
      <div class="rev_slider">
        ...
        <ul>
          ...
          <img src="<?php echo base_url(); ?>/assets/images/ladysmiling.jpg" alt="">

          <div class="caption sfl stl layer_8" data-x="right" data-y="73" data-hoffset="-60" data-easing="easeOutBack" data-speed="600" data-start="900">This is n8Shop</div>

          <div class="caption sfl stl layer_9" data-x="right" data-y="122" data-hoffset="-60" data-easing="easeOutBack" data-speed="600" data-start="1000">Home of Fashion</div>

          <div class="caption sfl stl layer_10" data-x="right" data-y="178" data-hoffset="-60" data-easing="easeOutBack" data-speed="600" data-start="1100">We know how important it is to look good, cos looking good is a good business.</div>
...
<!-- - - - - - - - - - - - - - End of Slide 3 - - - - - - - - - - - - - - - - -->
          ...
          <li data-transition="papercut" data-slotamount="7">
            ...
            <img src="<?php echo base_url(); ?>/assets/images/medication.jpg" alt="">
          ...
          <li data-transition="papercut" data-slotamount="7" class="align_center">
            ...
            <img src="<?php echo base_url(); ?>/assets/images/medication2.jpg" alt="">
