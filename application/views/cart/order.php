            ...
            <li><a href="<?php echo base_url(); ?>cart/orders">My Orders</a></li>
						<li>My Order</li>
					...
					<div class="row">
						...
						<?php include APPPATH. 'views/template/profile-menu.php'; ?>
												...
												<table class="table_type_1 order_table">
													...
													<tbody>
														...
														<tr>
															...
															<td><a href="mailto:#"><?php echo $this->session->userdata('email'); ?></a></td>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td data-title="Quantity">
                          ...
                          <div class="qty min clearfix" style="text-align: center;">
                          ...
                          <tr>
                            ...
                            echo number_format($grand_total, 2); ?></td>
								...
								<footer class="bottom_box">
									...
									<a href="<?php echo base_url(); ?>cart/orders" class="button_grey middle_btn">Back to My Orders</a>
