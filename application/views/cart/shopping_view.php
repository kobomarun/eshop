        ...
        <div id="cart" >
            ...
            // If cart is empty, this will show below message.
             ...
             echo 'To add products to your shopping cart click on "Add to Cart" Button'; 
                ...
                <table id="table" align="center" border="0" cellpadding="5px" cellspacing="1px">
                  <?php
                  ...
                  if ($cart = $this->cart->contents()): ?>
                    ...
                    <tr>
                        ...
                        <td colspan="5" align="right"><input type="button" class ='fg-button teal' value="Clear Cart" onclick="clear_cart()">
                            ...
                            <input type="button" class ='fg-button teal' value="Place Order" onclick="window.location = 'cart/billing_view'"></td>
                    </tr>
<?php endif; ?>
            </table>
        </div>
