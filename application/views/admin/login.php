...
<title>N8 Administrator --- Login</title>
<!-- Bootstrap Core CSS -->
...
<!-- color CSS -->
<link href="<?php echo base_url(); ?>admin/css/colors/gray-dark.css" id="theme"  rel="stylesheet">
...
<section id="wrapper" class="login-register">
  <div class="login-box">
    <div class="white-box">
      ...
      <?php } ?>
      <form class="form-horizontal form-material" id="loginform" action="<?php echo base_url(); ?>admin/login/authentication" method="post">
        <h3>N8 Admin Login</h3>
...
<script src="<?php echo base_url(); ?>admin/bootstrap/dist/js/tether.min.js"></script>
...
<!--Style Switcher -->
<script src="<?php echo base_url(); ?>admin/plugins/bower_components/styleswitcher/jQuery.style.switcher.js"></script>
</body>
</html>
